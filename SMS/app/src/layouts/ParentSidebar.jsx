...
import { LayoutDashboard, TrendingUp, Calendar, CreditCard, MessageSquare, Zap } from 'lucide-react';

export const ParentSidebar = ({ open }) => {
  const navItems = [
    { label: 'Dashboard', href: '/parent', icon: LayoutDashboard, end: true },
    { label: 'Academic Progress', href: '/parent/grades', icon: TrendingUp },
    { label: 'Attendance', href: '/parent/attendance', icon: Calendar },
    { label: 'Fees & Finance', href: '/parent/finance', icon: CreditCard },
    { label: 'Communication', href: '/parent/communication', icon: MessageSquare },
    { label: 'School Life', href: '/parent/school-life', icon: Zap },
  ];
    ...
    >
      ...
      <div className="flex items-center gap-sm mb-xxl px-xs pt-xs">
        ...
        <div>
          ...
          <p className="text-[10px] uppercase tracking-widest text-on-tertiary-container">Parent Portal</p>
        </div>
      </div>
